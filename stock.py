...
class Stock:
    ...
    def __init__(self, name: str) -> None:
        """
        Initialize the Stock with a name.
        """
        self.name: str = name
    ...
    def clone(self) -> "Stock":
        """
        Return a deep copy of the Stock instance.
        """
    ...
    def compute_rsi(self) -> None:
        ...
        over a 14-period (approximately) window.
        """
...
if __name__ == "__main__":
    ...
    # Clone for reference adjustments
    ref = s.clone()
